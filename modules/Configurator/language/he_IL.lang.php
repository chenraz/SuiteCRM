...
$mod_strings = array(
    ...
    'DEFAULT_SYSTEM_SETTINGS' => 'מערך משתמש',
    ...
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'הגדדרות מערכת',
    'LBL_LOGVIEW' => 'קונפיג הגדרות יומן',
    'LBL_MAIL_SMTPAUTH_REQ' => 'השתמש באוטנטיקציית SMTP',
    ...
    'LBL_MIN_AUTO_REFRESH_INTERVAL' => 'זמן מינימלי לרפרוש וידגטים',
    ...
    'LBL_MODULE_FAVICON' => 'תצוגת אייקון של מודול כפביקון',
    ...
    'LBL_DISALBE_CONVERT_LEAD' => 'כיבוי פעולות המרת ליד על לידים שכבר הומרו',
    ...
    'LBL_ENABLE_ACTION_MENU' => 'הצגת פעולות בתוך תפריטים',
    ...
    'LBL_ENABLE_INLINE_EDITING_LIST' => 'אפשור עריכת אינליין בתצוגת רשימות',
    ...
    'LBL_ENABLE_INLINE_EDITING_DETAIL' => 'אפשר עריכה אינליין בתצוגה פרטים',
    ...
    'LBL_HIDE_SUBPANELS' => 'הצגת תת-פאנילים סגורים',
    ...
    'MAX_DASHLETS' => 'מספר מקסימלי של וידגטים בעמוד הבית',
    ...
    'LBL_IMPORT_MAX_RECORDS' => 'מספר מקסימלי של רשומות לייבוא:',
    ...
    'SUITEPDF_ADVANCED_SETTINGS' => 'הגדרות מתקדמות',
