...
$mod_strings = array(
    ...
    'LBL_DISABLED_TITLE' => 'SuiteCRM התקנה בוטלה',
    ...
    'ERR_ADMIN_PASS_BLANK' => 'סיסמת המנהל SuiteCRM לא יכול להיות ריק.',
    ...
    'ERR_CHECKSYS_NOT_VALID_DIR' => 'ספריה לא חוקית',
    ...
    'ERR_DB_MYSQL_VERSION1' => 'גרסת MySQL ',
    ...
    'ERR_DB_PRIV_USER' => 'נדרש שם משתמש admin למסד הנתונים.',
    ...
    'ERR_LICENSE_NOT_FOUND' => 'קובץ רשיון לא נמצא!',
    ...
    'LBL_CONFIRM_LICENSE_TITLE' => 'פרטי רשיון',
    'LBL_CONFIRM_NOT' => '. לא',
    'LBL_CONFIRM_TITLE' => 'עצב הגדרות',
    'LBL_CONFIRM_WILL' => 'כאשר',
    'LBL_DBCONF_CREATE_DB' => 'צור מסד נתונים',
    ...
    'LBL_DBCONF_DB_PASSWORD' => 'סיסמת מסד נתונים',
    'LBL_DBCONF_DB_PASSWORD2' => 'הזן מחדש סיסמת מסד נתונים',
    'LBL_DBCONF_DB_USER' => 'שם מסד הנתונים',
    ...
    'LBL_LICENSE_DOWNLOAD_KEY' => 'מפתח הורדה',
    'LBL_LICENSE_EXPIRY' => 'תאריך תפוגה',
    'LBL_LICENSE_I_ACCEPT' => '. אני מקבל',
    'LBL_LICENSE_NUM_USERS' => 'מספר המשתמשים',
    ...
    'LBL_PERFORM_LICENSE_SETTINGS' => 'עדכון פרטי הרשיון',
    ...
    'LBL_PERFORM_OUTRO_7' => 'המערכת שלך עכשיו מותקנת ותצורתו נקבעה לשימוש.',
    ...
    'LBL_WELCOME_CHOOSE_LANGUAGE' => 'בחר/י את השפה שלך',
    'LBL_WELCOME_SETUP_WIZARD' => 'אשף ההתקנה',
    'LBL_WELCOME_TITLE_WELCOME' => 'ברוכים הבאים ל SuiteCRM ',
    'LBL_WELCOME_TITLE' => 'אשף ההתקנה SuiteCRM',
